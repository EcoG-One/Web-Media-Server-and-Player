...
bad_pls = ['.NFO.m3u', '00. play.m3u', '00.info.m3u', 'CD 1.m3u',
           'CD1.cuetools.flac.cue', 'CD1.m3u8', 'CD2.cd2.cuetools.flac.m3u',
           'CD2.m3u', 'CD2.m3u8', 'CD3.m3u8', 'CD4.m3u8', 'CDImage.ape.cue',
           'CDImage.cue', 'CDImage.m3u', 'Cd 1.m3u8', 'Cd No1.m3u8',
           'Cd No2.m3u8', 'Play.m3u', 'Playlist.m3u', 'Unknown Artist - Unknown Title.cue',
           'Unknown Artist - Unknown Title.m3u', 'Unknown Artist - Unknown Title.m3u8',
           'Use This To Burn.cue', 'Use This To Burn.m3u', 'cue (Disc 1).CUE',
           'cue (Disc 2).CUE', 'flac.cue', 'flac.m3u', 'image.cue', 'play.m3u',
           'playlist.m3u', 'CUE+APE.cue']

bad_dirs = []
pattern = ['disc *', 'cd*', 'cd *', 'disk *', 'part *', 'volume *', 'cd0*', 'cd 0*', 'cd no*', 'cue+ape']
for n in range(1, 7):
    for p in pattern:
        ...
        try:
            if pl_name in bad_pls and pl_path and os.path.exists(pl_path):
             ...
             #   file_path = os.path.join(root, file)
                ...
                cursor.execute("UPDATE Playlists SET path = ?, PL_name = ? WHERE id = ?", (new_path, new_name, song_id))
                print(new_path)
